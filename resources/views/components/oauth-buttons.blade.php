<div class="space-y-3">
    <a href="{{ route('oauth.redirect', 'google') }}" class="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 dark:hover:bg-gray-700 dark:focus:ring-offset-gray-800">
    ...
    <a href="{{ route('oauth.redirect', 'github') }}" class="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 dark:hover:bg-gray-700 dark:focus:ring-offset-gray-800">
...
<div class="my-6 flex items-center gap-3" aria-hidden="true">
    ...
    <span class="text-xs font-medium uppercase tracking-wider text-gray-400">or use email</span>
    <div class="h-px flex-1 bg-gray-200 dark:bg-gray-700"></div>
</div>
