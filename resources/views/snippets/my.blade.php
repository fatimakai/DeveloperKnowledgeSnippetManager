<x-app-layout>
            ...
            {{ __('My Snippets') }}
                   ...
                   class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow">
                    + New Snippet
                        ...
                        <a href="{{ route('snippets.export.all.json') }}"
                   class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg shadow">
                    Export All JSON
                </a>
                        <a href="{{ route('snippets.export.all.pdf') }}"
    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow">
            <form method="GET" action="{{ route('snippets.my') }}" class="space-y-0">
                    ...
                    @if($snippet->tags->count() > 0)
                        <div class="mb-3 flex flex-wrap gap-2">
                            @foreach($snippet->tags as $tag)
                                <a 
                                    href="{{ route('snippets.my', ['tag' => $tag->name]) }}"
