    ...
    <div class="grid gap-6">
        @forelse ($snippets as $snippet)
            <div class="p-6 bg-white dark:bg-gray-800 shadow rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                @livewire('explain-snippet', ['snippet' => $snippet], key('explain-my-' . $snippet->id))

                <!-- Action buttons -->
                <div class="flex space-x-2 mt-3 justify-end items-center flex-wrap gap-2">
                    <!-- Save and Like buttons -->
                    @livewire('save-snippet', ['snippet' => $snippet], key('save-my-' . $snippet->id))
                    @livewire('like-snippet', ['snippet' => $snippet], key('like-my-' . $snippet->id))
